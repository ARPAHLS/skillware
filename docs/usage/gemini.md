...
- [Gmail Handler](../skills/office/gmail_handler.md) — dedicated agent mailbox; interactive minimal loop: [`examples/gemini_gmail_minimal.py`](../../examples/gemini_gmail_minimal.py) (README quick start)
