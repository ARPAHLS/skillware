...
| `optimization/context_optimizer` | `context_optimizer_demo.py`, `context_optimizer_chain_demo.py` (local execute; fastembed) | `context_optimizer_gemini_loop.py` | (catalog page) | (catalog page) | (catalog page) | (catalog page) |
