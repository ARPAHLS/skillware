...
<!-- skill-doc-meta:end -->
<!-- skill-intent:begin -->
**Solves:** Interpret and generate Korean Gen-Z slang and internet register that foundation models routinely miss.
**Works with:** Gemini, Claude, OpenAI, DeepSeek, Ollama, and Bedrock-compatible host loops.
**Runtime:** Offline lexicon. No API keys.
<!-- skill-intent:end -->
**Recommended install:** `pip install "skillware[linguistics_korean_slang]"`. See [Install extras](../../usage/install_extras.md).

[Skill Library](../README.md) · [Linguistics](README.md) · [Testing](../../TESTING.md)
