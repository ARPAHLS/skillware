...
<!-- skill-doc-meta:end -->
<!-- skill-intent:begin -->
**Solves:** Quote, preview, and execute Uniswap V2 swaps and transfers from structured intent on Ethereum or Base.
**Works with:** Gemini, Claude, OpenAI, DeepSeek, Ollama, and Bedrock-compatible host loops.
**Runtime:** Needs `AGENT_WALLET_PRIVATE_KEY` and a chain RPC URL for live execution.
<!-- skill-intent:end -->

**Recommended install:** `pip install "skillware[defi_evm_tx_handler]"`. See [Install extras](../../usage/install_extras.md).

[Skill Library](../README.md) · [DeFi](README.md) · [Testing](../../TESTING.md)
...
| :--- | :--- | :--- | :--- | :--- |
| [`85d29f4`](https://github.com/ARPAHLS/skillware/commit/85d29f48bb4656af9ef3141d25c532cc5c7912b7) | docs: addressbook guide, evm tokens list, and example polish (#373, #374) | 23 Sep 2026 | `0.3.0` | [@rosspeili](https://github.com/rosspeili) |
| [`004e8cb`](https://github.com/ARPAHLS/skillware/commit/004e8cbd82) | feat(core): shared addressbook public_0x and evm_tx_handler v0.3.0 (#373, #374) | 23 Sep 2026 | `0.3.0` | [@rosspeili](https://github.com/rosspeili) |
