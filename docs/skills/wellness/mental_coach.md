...
<!-- skill-doc-meta:end -->
<!-- skill-intent:begin -->
**Solves:** Crisis triage and scoped wellness coaching guardrails so host agents do not improvise clinical advice.
**Works with:** Gemini, Claude, OpenAI, DeepSeek, Ollama, and Bedrock-compatible host loops.
**Runtime:** Offline knowledge base; optional `GOOGLE_API_KEY` when `run_evaluator` is enabled.
<!-- skill-intent:end -->

**Recommended install:** `pip install "skillware[wellness_mental_coach]"`. See [Install extras](../../usage/install_extras.md).

[Skill Library](../README.md) · [Wellness](README.md) · [Testing](../../TESTING.md)
