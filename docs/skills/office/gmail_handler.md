...
<!-- skill-doc-meta:end -->
<!-- skill-intent:begin -->
**Solves:** Send, search, read, and reply to Gmail with attachments from a dedicated agent mailbox.
**Works with:** Gemini, Claude, OpenAI, DeepSeek, Ollama, and Bedrock-compatible host loops.
**Runtime:** Needs `GMAIL_ADDRESS` and `GMAIL_APP_PASSWORD` (IMAP/SMTP).
<!-- skill-intent:end -->
