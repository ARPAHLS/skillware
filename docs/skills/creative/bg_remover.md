...
<!-- skill-doc-meta:end -->
<!-- skill-intent:begin -->
**Solves:** Remove image backgrounds locally and return transparent PNGs for creative and deck pipelines.
**Works with:** Gemini, Claude, OpenAI, DeepSeek, Ollama, and Bedrock-compatible host loops.
**Runtime:** Offline (`rembg`); first run may download the local model.
<!-- skill-intent:end -->
