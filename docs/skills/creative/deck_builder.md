...
<!-- skill-doc-meta:end -->
<!-- skill-intent:begin -->
**Solves:** Assemble editable PPTX decks from structured JSON specs with lint and outline helpers.
...
[Skill Library](../README.md) · [Creative](README.md) · [Testing](../../TESTING.md)
...
The skill lives in `skills/creative/deck_builder/`. [Skill anatomy](../../introduction.md#skill-anatomy). Vocabulary: [glossary](../../glossary.md). **Contract** — manifest in the bundle. **Assurance** — `test_skill.py` in the bundle.
...
| :--- | :--- | :--- | :--- | :--- |
| [`bddfda7`](https://github.com/ARPAHLS/skillware/commit/bddfda71438afca3e3e7318b5027cf10db7a8283) | feat(creative): deck_builder v0.2.0 baseline — placeholders, quality linting, archetypes, and new layouts (#336) (#337) | 16 Sep 2026 | `0.2.0` | [@tusharjamunkar](https://github.com/tusharjamunkar) |
