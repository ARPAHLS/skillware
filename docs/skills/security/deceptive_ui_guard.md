...
<!-- skill-doc-meta:end -->
<!-- skill-intent:begin -->
**Solves:** Detect deceptive HTML UI patterns (hidden controls, bait, pre-click traps) before a host agent clicks.
**Works with:** Gemini, Claude, OpenAI, DeepSeek, Ollama, and Bedrock-compatible host loops.
**Runtime:** Offline DOM scan; optional headless render extra for computed-style diff.
<!-- skill-intent:end -->
...
| [`compliance/tos_evaluator`](../compliance/tos_evaluator.md) | **Legal permission** to automate against robots.txt / terms |
...
| [`9d1152c`](https://github.com/ARPAHLS/skillware/commit/9d1152c049c3bcfe1b7f6b825decae1b09e104a7) | feat(security): deceptive_ui_guard v2 — render diff, zone weighting, allowlists (#314) (#327) | 3 Sep 2026 | `0.2.0` | [@tusharjamunkar](https://github.com/tusharjamunkar), [@rosspeili](https://github.com/rosspeili) |
