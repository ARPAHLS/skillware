...
- **Core / CLI:** Shared address book **`public_0x`** field, relaxed contact validation (email or wallet), top-level **`skillware addressbook`** commands (`list`, `edit`, `set-wallet`, `remove`, `open`), and **`skillware config open`** (#373, #374).
