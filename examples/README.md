...
| `gemini_uk_companies_house_handler.py` | `finance/uk_companies_house_handler` | Gemini | `[finance_uk_companies_house_handler]`, `[gemini]` | `GOOGLE_API_KEY`, `COMPANIES_HOUSE_API_KEY`; optional `GEMINI_MODEL` | Interactive v1.2.1 loop: composites, turn-by-turn pipelines, disambiguation, record truncation limits. |
| `claude_uk_companies_house_handler.py` | `finance/uk_companies_house_handler` | Claude | `[finance_uk_companies_house_handler]`, `[claude]` | `ANTHROPIC_API_KEY`, `COMPANIES_HOUSE_API_KEY`; optional `ANTHROPIC_MODEL` (default `claude-haiku-4-5-20251001`) | Interactive v1.2.1 loop with multi-turn tool chaining and disambiguation hints. |
