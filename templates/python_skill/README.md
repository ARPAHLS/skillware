...
Roles: [Skill anatomy](../../docs/introduction.md#skill-anatomy) — **Contract** (`manifest.yaml`), **Effect** (`skill.py`), **Directive** (`instructions.md`), **Assurance** (`test_skill.py`), **Presentation** (`card.json`). Terms: [glossary](../../docs/glossary.md).
